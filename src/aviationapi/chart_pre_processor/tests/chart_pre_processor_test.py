...
@patch("aviationapi.chart_pre_processor.app.lambda_function.AiracDataRepository.get_airac")
def test_get_current_airacs_requests_faa_source(mock_get_airac):
    mock_get_airac.side_effect = [
        ...
        _build_airac_data(CycleTypes.NEXT.value, CycleChartTypes.CHART_SUPPLEMENT.value),
    ]
