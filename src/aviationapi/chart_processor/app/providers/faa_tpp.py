...
def unzip_charts(download_path, file_name):
    ...
    with zipfile.ZipFile(download_path, "r") as zip_file:
        zip_file.extractall(charts_path)
...
def push_charts_to_s3(airac, charts_path):
    ...
    transfer_manager = s3transfer.create_transfer_manager(s3_client, transfer_config)
...
class FaaTppChartProvider(ChartProvider):
    ...
    def process_packet(self, packet, airac):
        ...
        return {"success": success, "cycle_chart_type": cycle_chart_type}
